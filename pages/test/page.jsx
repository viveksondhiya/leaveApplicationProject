  ...
  return (
    ...
    <div className="container">
      ...
      <div className="status">
        <form className="sendEmailForm" onSubmit={handleApprove}>
          <button type="submit" className="formButton approve">
            Approve
          </button>
        </form>
        <form className="sendEmailForm" onSubmit={handleReject}>
          <button type="submit" className="formButton reject">
            Reject
          </button>
        </form>
      </div>
      <style jsx>{`
        ...
        .approve {
          background-color: #6cd24d; /* Green color for approve button */
          color: white; 
        }
  
        .reject {
          background-color: #ff5858; /* Red color for reject button */
          color: white;
        }
  
        .formButton:hover {
          background-color: #d4d4d4; /* Light gray background on hover */
        }
      `}</style>
    </div>
  );
